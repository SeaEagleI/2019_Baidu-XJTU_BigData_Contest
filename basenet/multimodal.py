...
from basenet.senet import se_resnet50,se_resnext101_32x4d,se_resnext50_32x4d, se_resnext26_32x4d, se_resnet50
...
class MultiModalNet(nn.Module):
    def __init__(self, backbone1, backbone2, drop, pretrained=True):
        ...
        if backbone1 == 'se_resnext101_32x4d' :
            ...
            print("load pretrained model from ./pretrained_seresnet/se_resnext50_32x4d-a260b3a4.pth")
            state_dict = torch.load('./pretrained_seresnet/se_resnext50_32x4d-a260b3a4.pth')
            ...
            print("load pretrained model from ./pretrained_seresnet/se_resnet50-ce0d4300.pth")
            state_dict = torch.load('./pretrained_seresnet/se_resnet50-ce0d4300.pth')
